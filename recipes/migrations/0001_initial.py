    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to=functools.partial(ecookbook.utils.specific_upload_to, *(), **{'path': 'recipes/category_image'}), verbose_name='category image')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='description')),
                ('image', models.ImageField(blank=True, upload_to=functools.partial(ecookbook.utils.specific_upload_to, *(), **{'path': 'recipes/step_image'}), verbose_name='step image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('image', models.ImageField(blank=True, upload_to=functools.partial(ecookbook.utils.specific_upload_to, *(), **{'path': 'recipes/recipe_image'}), verbose_name='recipe image')),
